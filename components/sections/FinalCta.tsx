...
export function FinalCta() {
  ...
  return (
    <section className="border-t border-line bg-graphite-elevated py-[clamp(4rem,10vw,7.5rem)]">
      <div className="container-content max-w-3xl text-center">
        <h2 className="font-display text-display-section uppercase text-smoke">
          {t("title")}
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-smoke-muted">{t("description")}</p>
